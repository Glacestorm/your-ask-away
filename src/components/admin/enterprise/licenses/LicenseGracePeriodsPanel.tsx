...
import { useLicenseGrace, LicenseGracePeriod } from '@/hooks/admin/enterprise';
...
export function LicenseGracePeriodsPanel() {
  ...
  const handleCreateGrace = async () => {
    ...
    const endDate = addDays(new Date(), formData.grace_days);
          ...
          <CardContent className="pt-4">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold">{stats?.active || gracePeriods.filter(g => g.status === 'active').length}</p>
              </div>
          ...
          <CardContent className="pt-4">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold">{stats?.converted || gracePeriods.filter(g => g.status === 'converted').length}</p>
              </div>
          ...
          <CardContent className="pt-4">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold">{stats?.expired || gracePeriods.filter(g => g.status === 'expired').length}</p>
              </div>
