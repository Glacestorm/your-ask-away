...
const sectionMappings: Record<string, string> = {
  ...
  'exportacion-datos': 'exportacion-datos',
  'copia-seguridad': 'copia-seguridad',
  'consolidacion': 'consolidacion',
  'balance-situacion': 'balance-situacion',
  'estado-perdidas-ganancias': 'estado-perdidas-ganancias',
  ...
  'resultados-explotacion': 'resultados-explotacion',
  'resultados-financieros': 'resultados-financieros',
  'masas-patrimoniales': 'masas-patrimoniales',
  'cuadro-analitico': 'cuadro-analitico',
  'resumen-analitico': 'resumen-analitico',
  'flujo-caja': 'flujo-caja',
  'valor-anadido': 'valor-anadido',
  'cuadro-financiacion': 'cuadro-financiacion',
  'ebit-ebitda': 'ebit-ebitda',
  'capital-circulante': 'capital-circulante',
  'situacion-largo-plazo': 'situacion-largo-plazo',
  'flujos-tesoreria': 'flujos-tesoreria',
  'nof': 'nof',
  'cuadro-mando': 'cuadro-mando',
  'indice-z': 'indice-z',
  'ratios-liquidez': 'ratios-liquidez',
  'ratios-endeudamiento': 'ratios-endeudamiento',
  'ratios-sectoriales': 'ratios-sectoriales',
  'simulador-sectorial': 'simulador-sectorial',
  'piramide-ratios': 'piramide-ratios',
  'piramide-dupont': 'piramide-dupont',
  'analisis-bancario': 'analisis-bancario',
  'rentabilidad-economica': 'rentabilidad-economica',
  'umbral-rentabilidad': 'umbral-rentabilidad',
  'apalancamiento': 'apalancamiento',
  'fondo-maniobra': 'fondo-maniobra',
  'autofinanciacion': 'autofinanciacion',
  'periodos-maduracion': 'periodos-maduracion',
  'capacidad-crecimiento': 'capacidad-crecimiento',
  'nivel-endeudamiento': 'nivel-endeudamiento',
  'estados-financieros': 'estados-financieros',
  'resumen-financiero': 'resumen-financiero',
  'activo-neto': 'activo-neto',
  'valor-substancial': 'valor-substancial',
  'multiplos': 'multiplos',
  'flujos-descontados': 'flujos-descontados',
  'proyecciones': 'proyecciones',
  'proyecto-inversion': 'proyecto-inversion',
  'desv-balance': 'desv-balance',
  'desv-resultados': 'desv-resultados',
  'audit-fondo-maniobra': 'audit-fondo-maniobra',
  'audit-acid-test': 'audit-acid-test',
  'audit-disponibilidad': 'audit-disponibilidad',
  'audit-cobro': 'audit-cobro',
  'audit-pago': 'audit-pago',
  'audit-rotacion': 'audit-rotacion',
  'audit-apalancamiento': 'audit-apalancamiento',
  'audit-fondos-propios': 'audit-fondos-propios',
  'audit-endeudamiento': 'audit-endeudamiento',
  'ca-balance': 'ca-balance',
  'ca-perdidas-ganancias': 'ca-perdidas-ganancias',
  'ca-flujos-efectivo': 'ca-flujos-efectivo',
  'ca-cambios-patrimonio': 'ca-cambios-patrimonio',
  'ca-gastos-ingresos': 'ca-gastos-ingresos',
  'bateria-informes': 'bateria-informes',
  'estudio-sectorial': 'estudio-sectorial',
  'estudio-financiero': 'estudio-financiero',
  'comentarios-gestion': 'comentarios-gestion',
  'eva': 'eva',
  'per': 'per',
