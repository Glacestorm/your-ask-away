        ...
        <SidebarGroup className="mt-4">
          <SidebarMenu className="space-y-2">
            {!isAuditor && (
              <SidebarMenuItem>
                <SidebarMenuButton
                  onClick={() => onSectionChange('visit-sheets')}
                  isActive={isActive('visit-sheets')}
                  className="font-semibold py-3 rounded-xl transition-all hover:shadow-md group"
                  tooltip={!open ? {
                    children: 'Fichas de Visita',
                    className: "bg-gradient-to-br from-primary/10 to-primary/5 border-primary/20"
                  } : undefined}
                >
                  <div className="flex h-9 w-9 items-center justify-center rounded-lg bg-gradient-to-br from-primary to-primary/80 shadow-lg transition-all duration-300 hover:scale-110 hover:shadow-xl hover:shadow-primary/50 group-hover:rotate-3">
                    <FileText className="h-5 w-5 text-primary-foreground transition-all duration-300 group-hover:scale-110 group-hover:-rotate-3" />
                  </div>
                  <span className={`text-sm leading-tight transition-all duration-300 ${open ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-2'}`}>
                    Fichas de Visita
                  </span>
            ...
            {isCommercialManager && (
              <SidebarMenuItem>
                <SidebarMenuButton
                  onClick={() => onSectionChange('visit-validation')}
                  isActive={isActive('visit-validation')}
                  className="font-semibold py-3 rounded-xl transition-all hover:shadow-md group"
                  tooltip={!open ? {
                    children: 'Validación de Fichas',
                    className: "bg-gradient-to-br from-primary/10 to-primary/5 border-primary/20"
                  } : undefined}
                >
                  <div className="flex h-9 w-9 items-center justify-center rounded-lg bg-gradient-to-br from-green-500 to-green-600 shadow-lg transition-all duration-300 hover:scale-110 hover:shadow-xl hover:shadow-green-500/50 group-hover:rotate-3">
                    <ClipboardCheck className="h-5 w-5 text-white transition-all duration-300 group-hover:scale-110 group-hover:-rotate-3" />
                  </div>
                  <span className={`text-sm leading-tight transition-all duration-300 ${open ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-2'}`}>
            ...
            {!isAuditor && (
              <SidebarMenuItem>
                <SidebarMenuButton
                  onClick={() => onSectionChange('accounting')}
                  isActive={isActive('accounting')}
                  className="font-semibold py-3 rounded-xl transition-all hover:shadow-md group"
                  tooltip={!open ? {
                    children: 'Comptabilitat',
                    className: "bg-gradient-to-br from-primary/10 to-primary/5 border-primary/20"
                  } : undefined}
                >
                  <div className="flex h-9 w-9 items-center justify-center rounded-lg bg-gradient-to-br from-emerald-500 to-emerald-600 shadow-lg transition-all duration-300 hover:scale-110 hover:shadow-xl hover:shadow-emerald-500/50 group-hover:rotate-3">
                    <Calculator className="h-5 w-5 text-white transition-all duration-300 group-hover:scale-110 group-hover:-rotate-3" />
                  </div>
                  <span className={`text-sm leading-tight transition-all duration-300 ${open ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-2'}`}>
                    Comptabilitat
                  </span>
                  ...
                  <CollapsibleContent className="transition-all duration-300 data-[state=open]:animate-slide-in data-[state=closed]:animate-slide-out">
                    <SidebarGroupContent className="mt-2">
                      <SidebarMenu className="space-y-1">
                        ...
                        <SidebarMenuItem>
                          <SidebarMenuButton 
                            onClick={() => onSectionChange('goals-progress')} 
                            isActive={isActive('goals-progress')}
                            className="rounded-lg hover:bg-accent/50 transition-all group"
                          >
                            <Target className="h-4 w-4 transition-all duration-300 group-hover:scale-110 group-hover:text-primary" />
                            <span className="text-sm transition-all duration-300 group-hover:translate-x-1">Seguiment d'Objectius</span>
                          </SidebarMenuButton>
                        </SidebarMenuItem>
                        <SidebarMenuItem>
                          <SidebarMenuButton 
