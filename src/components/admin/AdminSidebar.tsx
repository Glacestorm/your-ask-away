        ...
        {isRegularGestor ? (
          ...
          <SidebarGroup>
            ...
            <SidebarMenuItem>
              ...
              {/* AI Obelixia - Agents, Copilot, Voice */}
              <SidebarMenuItem>
                <SidebarMenuButton
                  onClick={() => onSectionChange('ai-obelixia')}
                  isActive={isActive('ai-obelixia')}
                  className="font-semibold py-3 rounded-xl transition-all hover:shadow-md group"
                  tooltip={!open ? {
                    children: 'AI Obelixia',
                    className: "bg-gradient-to-br from-purple-500/10 to-purple-500/5 border-purple-500/20"
                  } : undefined}
                >
                  <div className="flex h-9 w-9 items-center justify-center rounded-lg bg-gradient-to-br from-purple-500 to-pink-600 shadow-lg transition-all duration-300 hover:scale-110 hover:shadow-xl hover:shadow-purple-500/50 group-hover:rotate-3">
              ...
              <SidebarMenuItem>
                ...
                >
                  <div className="flex h-9 w-9 items-center justify-center rounded-lg bg-gradient-to-br from-violet-500 to-purple-600 shadow-lg transition-all duration-300 hover:scale-110 hover:shadow-xl hover:shadow-violet-500/50 group-hover:rotate-3">
                    <Boxes className="h-5 w-5 text-white transition-all duration-300 group-hover:scale-110 group-hover:-rotate-3" />
                  </div>
                  <span className={`text-sm leading-tight transition-all duration-300 ${open ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-2'}`}>
                    Module Studio
                  </span>
