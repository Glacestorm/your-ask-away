        ...
        <div className="max-w-5xl mx-auto text-center">
          ...
          >
            <Link to="/store/modules">
              <Button 
                size="lg"
                className="bg-gradient-to-r from-emerald-500 to-emerald-600 hover:from-emerald-600 hover:to-emerald-700 text-white px-8 py-6 text-lg rounded-xl shadow-lg shadow-emerald-500/25 w-full sm:w-auto"
              >
                Explorar Módulos
            ...
            <Button 
              size="lg"
              variant="outline"
              className="border-slate-600 text-slate-300 hover:bg-slate-800/50 px-8 py-6 text-lg rounded-xl w-full sm:w-auto"
            >
