...
function getDefaultImprovements(): ImprovementsAnalysis & { 
  ...
  return {
    ...
    aiIntegrations: [
      ...
      "✅ INSTAL·LAT: Scoring creditici automàtic amb explicabilitat (useCreditScoring + credit-scoring Edge Function)",
      "✅ INSTAL·LAT: Detecció d'anomalies en transaccions (useAnomalyDetection + detect-anomalies Edge Function)",
      "✅ INSTAL·LAT: Recomanacions de productes personalitzades (useProductRecommendations + product-recommendations Edge Function)",
      "✅ INSTAL·LAT: Resum automàtic de fitxes de visita (useVisitSummary + summarize-visit Edge Function)",
      "✅ INSTAL·LAT: Predicció de churn de clients (useChurnPrediction + predict-churn Edge Function)",
      "✅ INSTAL·LAT: OCR intel·ligent per documents (useIntelligentOCR + intelligent-ocr Edge Function)"
    ],
    complianceUpdates: [
